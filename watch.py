...
from PyQt5.QtWidgets import QApplication, QLineEdit, QHBoxLayout, QWidget, QVBoxLayout, QLabel, QPushButton, QTextEdit
...
lv1.addWidget(l1, alignment = Qt.AlignHCenter)
lv1.addLayout(lh1)
lv1.addWidget(l2, alignment = Qt.AlignHCenter)
lv1.addLayout(lh2)
